 ...
 *
 */
public class FSEPlane extends Object3D {
     ...
     */
    public FSEPlane(float width, float height, int segmentsW, int segmentsH)
    {
     ...
     */
    public FSEPlane(float width, float height, int segmentsW, int segmentsH, int numTextureTiles)
    {
     ...
     */
    public FSEPlane(float width, float height, int segmentsW, int segmentsH, Axis upAxis)
    {
     ...
     */
    public FSEPlane(float width, float height, int segmentsW, int segmentsH, Axis upAxis, boolean createTextureCoordinates,
